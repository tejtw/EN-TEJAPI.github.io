...
| 10 | `share1`     | decimal(9,0)  | Announced Buying Vol	   | K shares | Upper limit on total amount of treasury stock |
...
| 13 | `wcroi`      | decimal(9,4)  | WROI during a Period%	   | %    | TAIEX return during the repurchase period                                |
